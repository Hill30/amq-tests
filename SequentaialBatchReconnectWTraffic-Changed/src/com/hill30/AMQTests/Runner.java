    ...
    private void Execute(String command) {
        ...
        switch(command) {
            ...
            case("r") :
                ...
                break;
            case("stats") :
                 final int[] lostAndDups = {0, 0};
                // sum zeros(not arrived messages), and dups with > 1
                adapters.forEach(a -> {
                    int[] tmp = a.checkForLostAndDups();
                    lostAndDups[0] = lostAndDups[0] + tmp[0];
                    lostAndDups[1] = lostAndDups[1] + tmp[1];
                });
                System.out.println(Arrays.toString(lostAndDups));
                break;
            case("?"):
                report();
                break;
